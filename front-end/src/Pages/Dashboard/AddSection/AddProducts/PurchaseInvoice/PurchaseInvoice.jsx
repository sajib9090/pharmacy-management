...
import InvoiceTitle from "../../../../../components/Invoice/InvoiceTitle/InvoiceTitle";
import InvoiceTableHead from "../../../../../components/Invoice/InvoiceTableHead/InvoiceTableHead";
import InvoiceTableContent from "../../../../../components/Invoice/InvoiceTableContent/InvoiceTableContent";
import InvoiceFooter from "../../../../../components/Invoice/InvoiceFooter/InvoiceFooter";
...
const PurchaseInvoice = () => {
  ...
  const handleRefresh = () => {
    ...
    navigate("/dashboard/add-section/add-products");
  };
      ...
      >
        ...
        <div className="shadow-md">
          ...
          <InvoiceFooter
            ...
            discount={purchaseItems?.totalDiscount?.toFixed(2)}
