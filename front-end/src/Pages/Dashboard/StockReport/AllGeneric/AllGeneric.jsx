      ...
      >
        <table className="overflow-x-scroll mx-auto sm:max-w-full md:max-w-full border-collapse w-full">
          <tr className="bg-gray-200 w-full">
            <th className="hidden md:block text-center border border-gray-300 p-2">
              No.
            </th>
            <th className="text-start p-[8px] border border-gray-300 w-[50%]">
              Generic
            </th>
            <th className=" border border-gray-300 w-[30%]">Created Date</th>
          ...
          {(searchTerm ? filteredData : data)?.map((item, index) => (
            <tr key={index} className="bg-gray-100 w-full">
              <>
                <td className="hidden md:block text-center border border-gray-300 p-2">
                  {index + 1}
                </td>
                <td className="text-start p-[8px] border border-gray-300 w-[50%]">
                  {item?.generic}
                </td>
                <td className=" border text-center border-gray-300 w-[30%]">
                  {item?.createdDate}
                </td>
