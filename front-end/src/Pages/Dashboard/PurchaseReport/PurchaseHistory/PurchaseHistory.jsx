      ...
      <div>
        ...
        <table className="overflow-x-scroll mx-auto sm:max-w-full md:max-w-full border-collapse w-full">
          <tr className="bg-gray-200 w-full">
            <th className="hidden md:block text-center p-2 border border-gray-300">
              Invoice Id
            </th>
            <th className="text-center p-2 border border-gray-300 w-[40%]">
              Date
            </th>

            <th className="text-center p-2 border border-gray-300 w-[10%]">
              Price
            </th>
            <th className="text-center p-2 border border-gray-300 w-[10%]">
              Discount
          ...
          {filteredData?.map((data, index) => (
            <tr key={index} className="bg-gray-100 w-full">
              <td className="hidden md:block text-center p-2 border border-gray-300">
                {data?._id}
              </td>
              <td className="text-start p-2 border border-gray-300 w-[40%]">
                {data?.createdTime}
              </td>
              <td className="text-center p-2 border border-gray-300 w-[15%]">
                {data?.invoice[0]?.beforeDiscountPrice}
              </td>
              <td className="text-center p-2 border border-gray-300 w-[10%]">
                {data?.invoice[0]
